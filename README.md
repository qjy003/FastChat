...
- [HttpBackendInterface-http后台任务服务接口模块](#class-httpbackendinterface-srcbasehttppy)
    - [define_request_format-接口请求数据的格式定义](#def-define_request_format-须用户继承实现-2)
...
### 接口调用顺序图
![后台接口调用顺序流程图](image/README.md.asserts/接口回调先后顺序.jpg)
